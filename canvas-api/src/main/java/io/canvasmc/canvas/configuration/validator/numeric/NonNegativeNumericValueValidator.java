...
public class NonNegativeNumericValueValidator implements AnnotationValidator<NonNegativeNumericValueValidator.NonNegativeNumericValue> {
    @Override
    public ValidationResult read(final NonNegativeNumericValue annotation, final JsonElement element) {
    ...
    @Override
    public Class<NonNegativeNumericValue> typeOf() {
